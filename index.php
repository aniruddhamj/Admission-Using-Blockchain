      ...
      <div class="row">
        <div class="col-12">
          <div class="login-card">
            <form class="theme-form login-form" method="post" action="submit_login.php">
              <h4><?php echo APP_NAME; ?></h4>
              <h6>Log in to your account.</h6>
              <div class="form-group">
                <label>Mobile No.</label>
                <div class="input-group">
                  <input class="form-control" type="number" name="username" id="username" placeholder="Your mobile no..." required />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <center><button class="btn btn-primary btn-block" type="submit">Sign in</button></center>
              </div>
              <p>Don't have account?<a class="ms-2" href="sign_up.php">Create Account</a></p><br><br>
                <?php 
